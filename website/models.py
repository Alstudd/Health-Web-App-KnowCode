...
class User(db.Model, UserMixin): # type: ignore
    ...
    emerEmail = db.Column(db.String(150), unique=True)
    emerNumber = db.Column(db.Integer)
...
class Upload(db.Model):    
    ...
    diabet = db.Column(db.String(1000))
    parkin = db.Column(db.String(1000))
    heart_dis = db.Column(db.String(1000))
    # image_file = db.Column(db.String(50))
    # image_data = db.Column(db.LargeBinary)
    # image_mimetype = db.Column(db.Text, nullable=False)
